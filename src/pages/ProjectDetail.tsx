...
const ProjectDetail = () => {
  ...
  const columns = [
    { id: "todo" as TaskStatus, title: "To Do", color: "bg-muted" },
    { id: "in-progress" as TaskStatus, title: "In Progress", color: "bg-info/20" },
    { id: "completed" as TaskStatus, title: "Done", color: "bg-success/20" },
  ];
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold">{format(project.dueDate, "MMM dd, yyyy")}</p>
                </div>
              </div>
            </CardContent>
          </Card>
